...
describe('AuthenticateUserService', function () {
    ...
    it('should not be able to authenticate with non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    auth = authenticateUserService.execute({
                        email: 'daniel@email.com',
                        password: '12345678',
                    });
                    return [4 /*yield*/, expect(auth).rejects.toBeInstanceOf(AppError_1.default)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should not be able to authenticate with password incorrect', function () { return __awaiter(void 0, void 0, void 0, function () {
        var userFake, auth;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({

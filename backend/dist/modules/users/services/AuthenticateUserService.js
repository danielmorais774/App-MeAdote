...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userInfo, passwordMatch, _b, secret, expiresIn, token;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        userInfo = _c.sent();
                        if (!userInfo) {
                            throw new AppError_1.default('combinação de email/password incorreto.', 401);
                        }
                        return [4 /*yield*/, this.hashProvider.compareHash(password, userInfo.password)];
                    case 2:
                        ...
                        return [2 /*return*/, { user: userInfo, token: token }];
                }
            });
        });
    };
